...
var RootCmd = &cobra.Command{
	Use:   "agenda",
	Short: "A simple agenda program",
	Long: `WOW, It's a agenda program written in Golang!
It was made with the help of cobra.
...
func init() {
	...
	RootCmd.Flags().BoolVarP(&des, "des", "d", false, "help you about using agenda.")
}
